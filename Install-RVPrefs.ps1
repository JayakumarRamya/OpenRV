...
$SourceRvpkg   = Join-Path $InstallDir  "stack_shortcuts-1_0.rvpkg"
$DestRvpkg     = Join-Path $RVPackagesDir "stack_shortcuts-1_0.rvpkg"
...
Write-Host ""
Write-Host "[ 4/4 ] Deploying stack_shortcuts-1_0.rvpkg..." -ForegroundColor Yellow
if (Test-Path $SourceRvpkg) {
    ...
    Write-Host "        stack_shortcuts-1_0.rvpkg → $DestRvpkg ($size bytes)" -ForegroundColor Green
    Write-Host "        Open RV → Preferences → Packages to confirm" -ForegroundColor Green
} else {
    Write-Host "        [SKIP] .rvpkg not found in _install" -ForegroundColor DarkGray
}
...
Write-Host "    3. stack_shortcuts-1_0.rvpkg   — keys 1/2/3 switching" -ForegroundColor Cyan
Write-Host "========================================================" -ForegroundColor Cyan
Write-Host ""
